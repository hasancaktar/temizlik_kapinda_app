...
class BosEvTemizligi extends StatefulWidget {
  const BosEvTemizligi({
    Key key,
  }) : super(key: key);

  @override
  _BosEvTemizligiState createState() => _BosEvTemizligiState();
}

class _BosEvTemizligiState extends State<BosEvTemizligi> {
